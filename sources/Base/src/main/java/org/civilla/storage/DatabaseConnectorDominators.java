...
public class DatabaseConnectorDominators {
    DatabaseConnectorBase<Dominator> connector = new DatabaseConnectorBase<>();

    public Dominator get(String objectId, String requestId) throws ExecutionException, InterruptedException {
        MongoDBProxyQueryResponseDominators resp = MongoDBProxyQueryResponseDominators.fromJson(connector.get(objectId, requestId));
