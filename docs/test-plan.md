...
#### 5.1.2 Failover and Recovery Testing (Тестирование на отказ и восстановление)
...
#### 5.1.3 Deployment testing (Тестирование развертывания)
...
#### 5.1.4 Production testing (Тестирование в production среде)
...
Обеспечение работоспособности продукта после развертывания в среде заказчика.
</td></tr><tr><td>
...
При развертывании продукта в среде заказчика, разработчик производит запуск небольшого пакета функциональных тестов, проверяющих нормальное функционирование продукта.
</td></tr><tr><td>
...
Среда разработчика, инструменты для функционального тестирования в production среде.
</td></tr><tr><td>
...
Контрольный пакет функциональных тестов успешно проходит после развертывания продукта в production среде.
</td></tr>
</table>
