...
**Длительность фазы 1: 0.5 года**

Следуя плану, сформированному в п. 4, в фазе 1 прототип продукта разрабатывается силами небольшого отдела и финансируется Equilibrium inc. При успешном завершении фазы 1 и получении предварительных заказов, с этого момента проект выходит на самоокупаемость и финансируется за счет предварительных продаж.

### Фаза 2. Разработка и поставка MVP. 

**Длительность фазы 2: 1 год**

В течение года разрабатывается MVP продукта, отделы продаж используют прототип для демонстрации и получают больше предзаказов.

### Фаза 3. Итеративная фаза разработки и продажи. 

**Длительность фазы 3: не ограничена**

После выпуска MVP, отдел продаж анализирует потребности заказчика и договаривается о сделках. Если условием сделок является добавление функционала в продукт, функционал добавляется. За счет постоянных клиентов, продукт начинает приносить стабильный доход.
