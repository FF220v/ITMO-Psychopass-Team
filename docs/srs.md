...
- Регистрация в системе инспекторов, исполнителей, аналитиков.
...
- **Аналитики** - Анализируют информацию, поступающую от системы в глобальном масштабе, прогнозируют рост преступности в разных районах, во время оперативного реагирования осуществляют информационную поддержку инспекторов.
...
- Сервис должен брат данные из Civilla - Database. 
- Сервис должен в удобной форме интерпретировать информацию из Civilla - Database, а именно отображать её в виде тепловой карты на фоне карты города.
...
- Система должна использовать веб-браузер для отображения тепловой карты коэффициента преступности.
- Система должна поддерживать изменение масштаба карты. 

### 3.2.2 Civilla - Police Control
