...
|                                       | |
|---------------------------------------|-|
|**The problem of (Проблема)**| <p>*[Опишите проблему]* <br><ul><li>У правительства и муниципальных управлений нет унифицированного цифрового механизма для борьбы с преступностью, который объединял бы все аспекты полицейского дела.</li><li>Накладные расходы на бюрократию и межведомственное взаимодействие могут и должны быть снижены<br>Соотношение цена/качество городской полиции должно быть улучшено</li></ul></p>
|**Affects (Влияет на)**| <p>*[Группа лиц, заинтересованных в решении проблемы]* <br><ul><li>Министерство внутренних дел</li><li>Муниципальные органы общественного порядка</li><li>Граждане страны/жители городов</li></ul></p>
|**The impact of which is (В результате чего)**| <p>*[Как проблема воздействует на заинтересованных лиц]* <br><ul><li>Как следствие перечисленных выше проблем, при высоких затратах на содержание органов общественного порядка, эффективность их работы всё ещё может быть существенно улучшена.</li></ul></p>
|**A successful solution would be (Решением этого является)**|<p>*[Что может решить проблему в рамках проекта]* <br><ul><li>Решением может стать внедрение унифицированной цифровой системы для управления министерствами, управляющими общественным порядком</li></ul></p>
