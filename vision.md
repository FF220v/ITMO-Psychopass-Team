...
|                                       | |
|---------------------------------------|-|
|**The problem of (Проблема)**| <p>*[Опишите проблему]*<br>* У правительства и муниципальных управлений нет унифицированного цифрового механизма для борьбы с преступностью, который объединял бы все аспекты полицейского дела. <br>Накладные расходы на бюрократию и межведомственное взаимодействие могут и должны быть снижены<br>Соотношение цена/качество по отношению к городской полиции должно быть улучшено</p> 
